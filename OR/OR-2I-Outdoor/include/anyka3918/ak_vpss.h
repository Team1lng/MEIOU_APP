...
{
	unsigned int exp_time_max;	  //�ع�ʱ������ֵ
	unsigned int exp_time_min;	  //�ع�ʱ�����Сֵ
	unsigned int d_gain_max;	  //������������ֵ
	unsigned int d_gain_min;	  //�����������Сֵ
	unsigned int isp_d_gain_min;	  // isp�����������С
	unsigned int isp_d_gain_max;	  // isp������������ֵ
	unsigned int a_gain_max;	  //ģ����������ֵ
	unsigned int a_gain_min;	  //ģ���������Сֵ
	unsigned int exp_step;		  //�û��ع��������
	unsigned int exp_stable_range;	  //�ȶ���Χ
	unsigned int target_lumiance[10]; //Ŀ������
	unsigned int envi_gain_range[10][2];
	unsigned int hist_weight[16];
	unsigned int BC_en;	      //���ⲹ��ʹ��
	unsigned int BC_detect_scope; //����ֱ��ͼ��ⷶΧ
	unsigned int BC_rate_max;     //ֱ��ͼ��������������
	unsigned int BC_rate_min;     //ֱ��ͼ����������С����
};
...
struct vpss_isp_3d_nr
{
	...
	unsigned short updata_ref;	    //����y/uv,default:1
	unsigned short tnr_refFrame_format; //�ο�֡�ĸ�ʽdefault:2
	...
	unsigned int md_th; //[0, 65535]  �˶������ֵ[0-127],default:0
};
