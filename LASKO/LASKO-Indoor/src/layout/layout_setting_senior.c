...
extern void sys_set_btn_syn_down(lv_obj_t *obj);
extern void sys_set_btn_syn_event(lv_obj_t *obj, lv_event_t event);
...
extern void sys_set_btn_syn_up(lv_obj_t *obj);
...
static void sys_Indoor_unlock_delay_set_btn_create(Controls_location **coordinate)
{
	...
	lv_obj_t *btn = sys_setting_btn_create(**coordinate, str1, text_str(STR_INDOOR_UNLOCK_TIME), &btn_data3, NULL, &btn_data2);
