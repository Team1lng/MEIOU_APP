...
###
 ...
 # @LastEditTime: 2024-11-13 15:22:41
...
update_app_dir()
{
        ...
        cp -f ../night_version/isp_gc2083-2024121107.conf ./app
        #cp -f ../night_version/isp_gc3003_mipi_2lane_av100_hp.conf ./app
        touch  ./app/$IPC_MODEL
}
...
# update_sdk_dir()
# {
#         rm -rf /home/share/two_wire_project/MEIOU/SDK/AK39EV33X_SDK_V1.04/rootfs/rootfs/app
#         cp -rf ./app /home/share/two_wire_project/MEIOU/SDK/AK39EV33X_SDK_V1.04/rootfs/rootfs/
#         rm -rf /home/share/two_wire_project/MEIOU/SDK/AK39EV33X_SDK_V1.04/rootfs/rootfs/daemon
#         cp -rf ./daemon /home/share/two_wire_project/MEIOU/SDK/AK39EV33X_SDK_V1.04/rootfs/rootfs/
# }
