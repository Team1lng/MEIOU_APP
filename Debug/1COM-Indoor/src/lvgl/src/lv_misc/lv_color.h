 ...
 *********************/
#ifdef SCS_VERSION1
#define LV_SCS_COLOR LV_COLOR_MAKE(0xF1, 0xD0, 0x7F)
#else
#define LV_SCS_COLOR LV_COLOR_MAKE(0xFF, 0xFF, 0xFF)
#endif
#define LV_COLOR_WHITE LV_SCS_COLOR // LV_COLOR_MAKE(0xFF, 0xFF, 0xFF)
