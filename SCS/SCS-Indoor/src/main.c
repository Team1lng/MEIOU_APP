...
static lv_task_t *mute_poll_task_t = NULL;
...
#ifdef SCS_VERSION
    mute_poll_task_t = lv_task_create(mute_poll_task, 60 * 1000, LV_TASK_PRIO_MID, NULL);
#endif
