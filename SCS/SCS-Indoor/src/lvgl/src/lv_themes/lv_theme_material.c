...
#ifdef SCS_VERSION
#define COLOR_SCR_TEXT (IS_LIGHT ? lv_color_hex(0x3b3e42) : LV_SCS_COLOR /*lv_color_hex(0xe7e9ec)*/)
#else
#define COLOR_SCR_TEXT (IS_LIGHT ? lv_color_hex(0x3b3e42) : LV_COLOR_WHITE /*lv_color_hex(0xe7e9ec)*/)
#endif

/*BUTTON*/
#define COLOR_BTN (IS_LIGHT ? COLOR_SCR_TEXT : LV_COLOR_BLACK /*lv_color_hex(0x586273)*/)
...
/*BACKGROUND*/
#define COLOR_BG (IS_LIGHT ? COLOR_SCR_TEXT : LV_COLOR_BLACK /*lv_color_hex(0x586273)*/)
...
#define COLOR_BG_TEXT (IS_LIGHT ? lv_color_hex(0x3b3e42) : COLOR_SCR_TEXT)
#define COLOR_BG_TEXT_PR (IS_LIGHT ? lv_color_hex(0x3b3e42) : COLOR_SCR_TEXT)
#define COLOR_BG_TEXT_CHK (IS_LIGHT ? COLOR_SCR_TEXT : COLOR_SCR_TEXT)
#define COLOR_BG_TEXT_CHK_PR (IS_LIGHT ? COLOR_SCR_TEXT : COLOR_SCR_TEXT)
...
static void basic_init(void)
{
    ...
    lv_style_set_text_color(&styles->btn, LV_STATE_DEFAULT, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_text_color(&styles->btn, LV_STATE_PRESSED, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_text_color(&styles->btn, LV_STATE_CHECKED, COLOR_SCR_TEXT);
    lv_style_set_text_color(&styles->btn, LV_STATE_CHECKED | LV_STATE_PRESSED, COLOR_SCR_TEXT);
    lv_style_set_text_color(&styles->btn, LV_STATE_DISABLED, IS_LIGHT ? lv_color_hex(0x888888) : lv_color_hex(0x888888));

    lv_style_set_image_recolor(&styles->btn, LV_STATE_DEFAULT, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_image_recolor(&styles->btn, LV_STATE_PRESSED, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_image_recolor(&styles->btn, LV_STATE_PRESSED, COLOR_SCR_TEXT);
    lv_style_set_image_recolor(&styles->btn, LV_STATE_CHECKED | LV_STATE_PRESSED, COLOR_SCR_TEXT);
    lv_style_set_image_recolor(&styles->btn, LV_STATE_DISABLED, IS_LIGHT ? lv_color_hex(0x888888) : lv_color_hex(0x888888));

    lv_style_set_value_color(&styles->btn, LV_STATE_DEFAULT, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_value_color(&styles->btn, LV_STATE_PRESSED, IS_LIGHT ? lv_color_hex(0x31404f) : COLOR_SCR_TEXT);
    lv_style_set_value_color(&styles->btn, LV_STATE_CHECKED, COLOR_SCR_TEXT);
    lv_style_set_value_color(&styles->btn, LV_STATE_CHECKED | LV_STATE_PRESSED, COLOR_SCR_TEXT);
...
static void textarea_init(void)
{
    ...
    lv_style_set_text_color(&styles->ta_placeholder, LV_STATE_DEFAULT,
                            IS_LIGHT ? COLOR_SCR_TEXT : lv_color_hex(0xa1adbd));
#endif
}
