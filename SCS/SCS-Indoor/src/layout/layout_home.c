...
#ifdef SCS_VERSION
#define ICON_OFS_X 200 //图标 X 轴偏移量宏定义
#define ICON_OFS_Y 100
#else
#define ICON_OFS_X 0
#define ICON_OFS_Y 0
#endif
...
lv_obj_t *home_btn_create_1(Controls_location coordinate, char *string, btn_data *btn_pdata, const void *img_src1, const void *img_src2)
{
	...
	lv_obj_set_style_local_bg_opa(btn, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_OPA_TRANSP);//默认状态透明
	lv_obj_set_style_local_bg_opa(btn, LV_LABEL_PART_MAIN, LV_STATE_PRESSED, LV_OPA_TRANSP);//按下状态透明
